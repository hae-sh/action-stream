...
var require_populate = __commonJS({
  "node_modules/form-data/lib/populate.js"(exports, module) {
    module.exports = function(dst, src2) {
...
var from = ({ name, prefix, encode: encode5, decode: decode5 }) => new Codec(name, prefix, encode5, decode5);
var baseX = ({ prefix, name, alphabet }) => {
  const { encode: encode5, decode: decode5 } = base_x_default(alphabet, name);
  return from({
    prefix,
    name,
    encode: encode5,
