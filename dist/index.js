...
module.exports = eval("require")("./shaToCid");
...
// EXTERNAL MODULE: ./node_modules/@vercel/ncc/dist/ncc/@@notfound.js?./shaToCid
var _notfoundshaToCid = __nccwpck_require__(50);
...
async function run() {
    try {
        ...
        const cid = (0,_notfoundshaToCid.shaToCid)(sha);
        const data = {
            cid: { "/": cid.toString() },
            sha,
            ref,
        };
        const result = await lib_axios.post("http://api.dice.staging.hae.sh/streams/" +
            core.getInput("haesh_stream_id"), data, {
            headers: {
                [core.getInput("haesh_stream_header_name")]: core.getInput("haesh_stream_header_value"),
                "Content-Type": "application/json",
            },
        });
